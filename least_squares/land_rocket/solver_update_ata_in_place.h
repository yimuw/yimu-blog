...
{
public:
    virtual VectorXd solver_rocket_landing_least_squares_single_step(const RocketLandingResiduals &residual) override
    {
        ScopeProfiler p("DenseSolverUpdateInPlace:solver_rocket_landing_least_squares_single_step");
