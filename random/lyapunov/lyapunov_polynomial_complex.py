...
class LinearSystemLyapunov:
    ...
    def polynomial_arrangement(self):
        ...
        z = sympy.Matrix([[x, y, x**2, x*y, y**2, x**3, x**2*y, x*y**2, y**3]]).transpose()
        ...
        b2 = sympy.Matrix([[x, y, x**2, x*y, y**2, x**3, x**2*y, x*y**2, y**3]]).transpose()
